...
// Source: configuration/global-config.go
//
// Generated by this command:
//
//	mockgen -destination mocks/mock-global-viper-config.go -package mocks -source configuration/global-config.go -mock_names ViperConfig=MockViperConfig
//
