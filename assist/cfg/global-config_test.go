...
import (
	...
	"github.com/snivilised/sundae/assist/mocks"
...
var _ = Describe("GlobalConfig", Ordered, func() {
	...
	BeforeEach(func() {
		viper.Reset()
		config = &cfg.GlobalViperConfig{}

		config.SetConfigName("sundae")
		config.SetConfigType("yml")

		relative = lab.Repo("test/configuration")
...
var _ = Describe("other", Ordered, func() {
	var relative string
